 ...
 */
package bambagiottiandreaserverrest;

/**
 *
 * @author bambagiotti.andrea
 */
...
public class GetHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            // Parsing dei valori
            double operando1 = Double.parseDouble((String) parametri.get("operando1"));
            double operando2 = Double.parseDouble((String) parametri.get("operando2"));
            String operatore = (String) parametri.get("operatore");
